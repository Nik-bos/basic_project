...
def load_save_data(parameters_path: str):

    # Load data using read_csv function
    df = read_csv(parameters_path)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--parameters_path", default="parameters.yaml")
    args = parser.parse_args()
    load_save_data(parameters_path = args.parameters_path)